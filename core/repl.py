...
Examples:
  ...
  generate implement bubble sort algorithm
  gen "create a class for handling user authentication"
...
The file content will be displayed with appropriate syntax highlighting
based on the file extension.
""",
            'edit': """
Edit an existing file using AI

Usage: edit <filename> <prompt>

Examples:
  edit app.py "add error handling to all functions"
  edit script.py "optimize for performance"
  edit config.py "add logging configuration"

The AI will read the existing file and modify it based on your prompt.
""",
            'think': """
Think through a problem step by step

Usage: think <problem description>

Examples:
  think "how to implement a search algorithm"
  think "what are the pros and cons of different database types"
""",
            'reason': """
Reason through a problem with a specified strategy

Usage: reason <strategy> <problem description>
...
Examples:
  reason first_principles "what is the best way to learn a new language"
  reason critical_thinking "how can I improve my time management skills"
""",
            'analyze': """
Analyze a problem or code file

Usage: analyze <problem|filename>

Examples:
  analyze "how to improve this code"
  analyze app.py
""",
            'strategies': """
Show available reasoning strategies
...
Displays a table of available reasoning strategies, their descriptions,
...
Displays a table of recent reasoning chains, including the problem,
strategy used, number of steps, and confidence level.
Use 'reasoning clear' to clear the history.
"""
        }
